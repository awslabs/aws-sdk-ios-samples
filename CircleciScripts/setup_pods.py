...
def setup_pods(app_repo_root_directory, appname, app_config):
    ...
    runcommand(command = "pod setup --silent", exception_to_raise = SetupMasterRepoPodsException(appname))
    ...
    for podspec in podspec_files:
        ...
        runcommand(command = "pod repo push --allow-warnings --silent {0} {1}".format(private_podspecs_local_reponame, podspec_path),
